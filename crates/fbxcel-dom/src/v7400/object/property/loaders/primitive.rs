...
impl LoadProperty<'_> for PrimitiveLoader<bool> {
    ...
    fn load(self, node: &PropertyHandle<'_>) -> Result<Self::Value, Self::Error> {
        ...
        match value_part[0] {
            ...
            ref v => Err(prop_type_err!("boolean", v.attribute_type(), node)),
        }
    }
}
...
impl LoadProperty<'_> for PrimitiveLoader<i32> {
    ...
    fn load(self, node: &PropertyHandle<'_>) -> Result<Self::Value, Self::Error> {
        ...
        match value_part[0] {
            ...
            ref v => Err(prop_type_err!("i32", v.attribute_type(), node)),
        }
    }
}
...
impl LoadProperty<'_> for PrimitiveLoader<u32> {
    ...
    fn load(self, node: &PropertyHandle<'_>) -> Result<Self::Value, Self::Error> {
        ...
        match value_part[0] {
            ...
            ref v => Err(prop_type_err!("u32", v.attribute_type(), node)),
        }
    }
}
...
impl LoadProperty<'_> for PrimitiveLoader<i64> {
    ...
    fn load(self, node: &PropertyHandle<'_>) -> Result<Self::Value, Self::Error> {
        ...
        match value_part[0] {
            ...
            ref v => Err(prop_type_err!("i64", v.attribute_type(), node)),
        }
    }
}
...
impl LoadProperty<'_> for PrimitiveLoader<u64> {
    ...
    fn load(self, node: &PropertyHandle<'_>) -> Result<Self::Value, Self::Error> {
        ...
        match value_part[0] {
            ...
            ref v => Err(prop_type_err!("u64", v.attribute_type(), node)),
        }
    }
}
