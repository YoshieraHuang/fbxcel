...
use super::Parser;
use crate::pull_parser::{error::DataError, Result, SyntacticPosition, Warning};
use async_position_reader::AsyncPositionRead;
use async_trait::async_trait;
use byte_order_reader::FromAsyncReader;
use byteorder::{ByteOrder, LE};
use fbxcel_low::{v7400::{FbxFooter, AttributeType, SpecialAttributeHeader}, FbxVersion};
...
impl_from_async_parser!(u8, i8, u16, i16, u32, i32, u64, i64, i128, f32, f64, AttributeType, SpecialAttributeHeader);